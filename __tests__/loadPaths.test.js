...
test('pathToDashed', () => {
  expect(pathToDashed('http://ru.hexlet.io/courses/image.jpg')).toBe('ru-hexlet-io-courses-image.jpg')
  expect(pathToDashed('folder/newFile.ext')).toBe('folder-newFile.ext')
